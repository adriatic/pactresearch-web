...
-- see that repo's 20260915041500_discussion_delete_lock_check.sql. NOT
-- YET APPLIED: drafted for Nik to review and run himself against
...
-- (execution_lock_stale_after() already exists on production, from the
-- same 20260908224401 migration production already has.)
--
